...
= 1.0.4 =
* Added top margin for sticky header

= 1.0.3 =
* Added option to hide header before provided screen size

= 1.0.2 =
* Fix hover color on secondary menu item
* Fix secondary menu paddings
